...
function App() {
  ...
  return (
    <div className="w-screen h-screen bg-blue-100 flex justify-center items-center p-5">
      <div className="max-w-[1300px] mx-auto bg-white h-[700px] rounded-lg shadow-2xl p-12 ">
        <div className="w-full flex flex-row justify-between pb-">
          <h1 className="text-xl font-bold">My Courses</h1>
          <a className="text-lg text-violet-500 font-semibold" href="#">
            View All
          </a>
        </div>
